...
# DEFAULTS:
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/alaq/voidrice.git" && repobranch="voiddwm"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/alaq/LARBS/master/voiddwm/vprogs.csv"
